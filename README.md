...
- ## [Скриншоты работы приложения](#Скриншоты)
- ## [Ключевой функционал:](#Ключевой)
  - ### [Авторизация и регистрация: IMS-auth-api](#Авторизация)
  - ### [Создание и назначение заданий: IMS-staff-api](#Создание)
  - ### [Работа со складом: IMS-product-api](#Работа)
- ## [Архитектура веб-клиента](#Архитектура)
- ## [Используемые технологии](#Используемые)
