...
# Ключевой функционал
## Авторизация и Регистрация (ims-auth-api) https://github.com/MrPrograMax/ims-authentication-api
...
## Создание и назначение заданий (ims-staff-api) https://github.com/MrPrograMax/ims-staff-api
...
## Работа со складом (ims-product-api) https://github.com/MrPrograMax/ims-product-api
