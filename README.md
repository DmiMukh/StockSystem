...
- ## [Скриншоты работы приложения](#Скриншоты_работы_приложения)
- ## [Ключевой функционал:](#Ключевой_функционал)
- - ### [Авторизация и регистрация: IMS-auth-api](#Авторизация_и_Регистрация_(ims-auth-api))
  - ### [Создание и назначение заданий: IMS-staff-api](#Создание_и_назначение_заданий_(ims-staff-api))
  - ### [Работа со складом: IMS-product-api](#Работа_со_складом_(ims-product-api))
